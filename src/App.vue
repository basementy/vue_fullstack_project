    ...
    <div id="main">
      <div class="container">
          ...
          <div class="col-md">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <br />
                <input type="text" placeholder="Digito o prefixo" class="form-control" />
              </div>
            </div>
          </div>
          <div class="col-md">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <br />
                <input type="text" placeholder="Digito o sufixo" class="form-control" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            <ul class="list-group">
              <li class="list-group-item" v-for="domain in domains" :key="domain.name">{{ domain }}</li>
            </ul>
          </div>
        </div>
      </div>
